...
// JogoNovo cria e retorna uma nova instância do jogo
func JogoNovo() Jogo {
...
// JogoCarregarMapa lê um arquivo texto linha por linha e constrói o mapa do jogo
...
// JogoPodeMoverPara verifica se o personagem pode se mover para a posição (x, y)
...
// JogoMoverElemento move um elemento para a nova posição
